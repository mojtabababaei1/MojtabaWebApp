...
namespace CodeYad_Blog.CoreLayer.Mappers
{
    public class PostMapper
    {
        ...
        public static Post DeletePost(DeletePostDto delettDto, Post post)
        {

            post.Description = delettDto.Description;
            post.Title = delettDto.Title;
            post.CategoryId = delettDto.CategoryId;
            post.Slug = delettDto.Slug.ToSlug();
            post.SubCategoryId = delettDto.SubCategoryId;
            post.IsSpecial = delettDto.IsSpecial;
