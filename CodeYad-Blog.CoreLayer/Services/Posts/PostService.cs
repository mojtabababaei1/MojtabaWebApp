...
namespace CodeYad_Blog.CoreLayer.Services.Posts
{
    public class PostService : IPostService
    {
        ...
        {
            return _context.Posts.Select(p => PostMapper.MapToDto(p)).ToList();
            //Categories.Select(category => CategoryMapper.Map(category)).ToList();
        }

        public PostDto DeletPostById(int id)
        {
